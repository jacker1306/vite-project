<template>
    <div class="bg-gray-200 py-10">
        <h3 data-aos="fade-up" class="text-3xl mb-2">CATEGORIES</h3>
        ...
        <div class="w-4/5 flex flex-wrap mx-auto justify-between items-stretch mt-8">
            <a data-aos="fade-up" href="#" v-for="fashion in fashions.slice(0,4)" :key="fashion.id" class="w-full sm:w-2/5 lg:w-1/5 mx-1 my-3 flex flex-col justify-between">
